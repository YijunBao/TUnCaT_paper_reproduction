...
% toc;
% load([dir_traces,'traces_ours_Raw\raw\',Exp_ID,'.mat'],'traces','bgtraces');
% traces = traces';
% bgtraces = bgtraces';

%%
nn=16; % 16 for 10, 51 for 10, 55 for 4
mask=ROIs(:,:,nn);
...
%%
imshow_range = [250,550]; % [150,450]; % [300,600]; % 
