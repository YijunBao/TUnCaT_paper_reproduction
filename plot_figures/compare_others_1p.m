...
%     sigma_from = 'Raw';
    list_scorefile = {['scores_split_bgsubs_',video,'Video',baseline_std,'.mat'],...
        ...
        ['scores_split_ours_',video,'Video_merge',addon,'_UnmixSigma',baseline_std,'.mat']...
        }';
%         ['scores_',video,'Video_traces_ours_',video,'_sigma1_diag11_v1_RawSigma.mat'],...
%     list_scorefile{1}=list_scorefile{3};
    list_tracefile = {['traces_ours_',video,'_merge'],...
        ['traces_FISSA_',video,'_merge'],...
        ['traces_CNMF_',video,'_p1','_merge'],...
        ['traces_AllenSDK_',video,'_merge'],...
        ['traces_ours_',video,'_merge',addon]...
        }';
...
%         method = list_method(mid);
        ...
        load(fullfile('.\',spike_type,list_scorefile{mid}),'list_recall','list_precision','list_F1','list_alpha','list_thred_ratio');
...
%             spikes_eval_array{mid,vid}=saved_result.spikes_eval_array{ii,ind_thred_ratio};
            ...
            [recall(mid,vid), precision(mid,vid), F1(mid,vid),individual_recall{mid,vid},individual_precision{mid,vid},spikes_GT_array{mid,vid},spikes_eval_array{mid,vid}]...
                = GetPerformance_SpikeDetection(output,traces_filt,thred_ratio,sigma,mu);
