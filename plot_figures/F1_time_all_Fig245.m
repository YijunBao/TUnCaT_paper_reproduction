...
load(sprintf('%s\\timing_all_methods_split %s%s x5.mat',dir_scores,addon,baseline_std),...
...
saveas(gcf,sprintf('F1 x%d ABO%s%s.png',num_method,addon,baseline_std));
% saveas(gcf,sprintf('F1 x%d ABO%s%s.emf',num_method,addon,baseline_std));
...
% set(gca,'Position',two_errorbar_position);
% title('F1 of all methods, ABO')
saveas(gcf,sprintf('time x%d ABO%s%s.png',num_method,addon,baseline_std));
% saveas(gcf,sprintf('time x%d ABO%s%s.emf',num_method,addon,baseline_std));
...
saveas(gcf,sprintf('ROC x%d ABO%s%s.png',num_method,addon,baseline_std));
...
dir_scores=['..\results\',spike_type,'\evaluation\'];
% dir_scores=['..\evaluation\',spike_type,'\'];
load([dir_scores,'\timing_all_methods_split ',addon,baseline_std,' x5.mat'],...
    'list_alpha_all_time','Table_time_all','list_method','list_video',...
    'list_recall_all','list_precision_all','list_F1_all','list_alpha_all','list_thred_ratio_all')
num_video = length(list_video);
num_Exp = 9;
...
% set(gca,'Position',two_errorbar_position);
% title('F1 of all methods, ABO')
saveas(gcf,sprintf('F1 x%d 1p %s%s.png',num_method,addon,baseline_std));
% saveas(gcf,sprintf('F1 x%d 1p %s%s.emf',num_method,addon,baseline_std));
...
% set(gca,'Position',two_errorbar_position);
% title('F1 of all methods, ABO')
saveas(gcf,sprintf('time x%d 1p %s%s.png',num_method,addon,baseline_std));
% saveas(gcf,sprintf('time x%d 1p %s%s.emf',num_method,addon,baseline_std));
...
legend(list_method,'Interpreter','none','numcolumns',1,...
    'Location','SouthWest','FontName','Arial','FontSize',14);
% saveas(gcf,sprintf('F1 %s %d 0503.emf',simu_opt,numbars));
saveas(gcf,sprintf('ROC x%d 1p %s%s.png',num_method,addon,baseline_std));
...
addon = ''; %_corr_fixed_alpha '_pertmin=0.16_eps=0.1_range'; % 
baseline_std = '_ksd-psd'; % '_psd'; % ''; % 
spike_type = 'NAOMi';
dir_scores=['..\results\',spike_type,'\evaluation\'];
% dir_scores=['..\evaluation\',spike_type,'\'];
load([dir_scores,'\timing_',simu_opt,'_all_methods_split ',addon,baseline_std,' x5.mat'],...
    'list_alpha_all_time','Table_time_all','list_method','list_video',...
    'list_recall_all','list_precision_all','list_F1_all','list_alpha_all',...
    'list_thred_ratio_all')
num_video = length(list_video);
num_Exp = 10;
...
% set(gca,'Position',two_errorbar_position);
% title('F1 of all methods, ABO')
saveas(gcf,sprintf('F1 x%d %s %s%s.png',num_method,simu_opt,addon,baseline_std));
% saveas(gcf,sprintf('F1 x%d %s %s%s.emf',num_method,simu_opt,addon,baseline_std));
...
% set(gca,'Position',two_errorbar_position);
% title('F1 of all methods, ABO')
saveas(gcf,sprintf('time x%d %s %s%s.png',num_method,simu_opt,addon,baseline_std));
% saveas(gcf,sprintf('time x%d %s %s%s.emf',num_method,simu_opt,addon,baseline_std));
...
legend(list_method,'Interpreter','none','numcolumns',1,...
    'Location','SouthWest','FontName','Arial','FontSize',14);
% saveas(gcf,sprintf('F1 %s %d 0503.emf',simu_opt,numbars));
saveas(gcf,sprintf('ROC x%d %s %s%s.png',num_method,simu_opt,addon,baseline_std));
