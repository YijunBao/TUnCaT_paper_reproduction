...
if __name__ == '__main__':
    # sys.argv = ['py', 'downsample', 'Raw', '1', '1', '0', '0']
    list_alpha = [0.1, 0.2, 0.3, 0.5, 1, 2, 3, 5, 10, 20, 30]  # 
    # list_alpha = [0.1, 0.2, 0.3, 0.5, 1, 2, 3, 5, 10, 20, 30, 50, 100, 200, 300, 500]  # 
    # list_alpha = [0.03, 0.05, 0.1, 0.2, 0.3, 0.5, 1, 2, 3] # 
    # list_alpha = [0.01, 0.02, 0.03, 0.05] # 
    # list_alpha = [200, 300, 500, 1000] # 
    list_Exp_ID = ['501484643','501574836','501729039','502608215','503109347',
        '510214538','524691284','527048992','531006860','539670003']
    # list_Exp_ID = ['501574836']
    ...
    if nbin == 1:
        ...
        bin_option = sys.argv[1] # 'mean' # 'sum' # 'downsample'
        if bin_option == 'mean':
    ...
    addon += '_novideounmix_r2_fixed_alpha_eg'
