...
python "C:\Matlab Files\timer\timer_start_from_file.py"

REM python gen_SNR_videos_NAOMi7_time.py 120s_30Hz_N=200_100mW_noise10+23_NA0.8,0.6_GCaMP6f

python gen_SNR_videos_NAOMi7_time.py 120s_30Hz_N=200_100mW_noise10+23x0.3_NA0.8,0.6_GCaMP6f
python gen_SNR_videos_NAOMi7_time.py 120s_30Hz_N=200_100mW_noise10+23x0.1_NA0.8,0.6_GCaMP6f
python gen_SNR_videos_NAOMi7_time.py 120s_30Hz_N=200_100mW_noise10+23x0_NA0.8,0.6_GCaMP6f
...
REM python gen_SNR_videos.py
REM python gen_SNR_videos_ABO_full.py
